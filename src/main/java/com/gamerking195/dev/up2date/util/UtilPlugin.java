    ...
    public static void unload(Plugin plugin) {
        ...
        if (pluginManager != null) {
            ...
            try {
                ...
                Up2Date.getInstance().printError(ex, "Error occurred while deleting plugin jar. #3");
            } catch (IllegalAccessException ex) {
                Up2Date.getInstance().printError(ex, "Error occurred while deleting plugin jar. #2");
            }
        ...
        if (cl instanceof URLClassLoader) {
            ...
            try {
                ...
                Up2Date.getInstance().printError(ex, "Error occurred while deleting plugin jar. #4");
            }
